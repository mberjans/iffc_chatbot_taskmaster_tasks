# Product Requirements Document: 002-Develop Magnetic Rag Prompt

## Overview

Implement 002-develop magnetic rag prompt as part of the Nexus Scholar AI project, specifically for ticket NXS-4G under the PROMPT_OPTIMIZER_DEV agent.
...
**Task Details:**
- **Task ID**: PROMPT_OPTIMIZER_DEV-NXS-4G-002-DEVELOP_MAGNETIC_RAG_PROMPT
- **Agent**: PROMPT_OPTIMIZER_DEV
- **Ticket**: NXS-4G
- **Component**: 002-Develop Magnetic Rag Prompt
